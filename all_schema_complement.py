...
can_entity_label = r'entity_label.pkl'
...
#获取候选表所具有的实体
can_entity = r'can_entity_list.pkl'
can_entity_list = []
...
#获取属性出现的频数
one_att_freq = []
with open('one_att_freq.pkl', 'rb') as f:
    one_att_freq = pickle.load(f)

two_att_freq = []
with open('two_att_freq.pkl', 'rb') as f:
